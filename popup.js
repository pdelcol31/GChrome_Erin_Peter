...
document.addEventListener("DOMContentLoaded", async ()=> {
    ...
    // const welcome_message = userDataChars[0];
    // const total_tokens = userDataChars[1];
    // const avg_tokens = userDataChars[2];
    // const total_carbon = userDataChars[3];
    // const avg_carbon = userDataChars[4];
    // const total_miles = userDataChars[5];
    // const total_water = userDataChars[6];
    // const avg_water = userDataChars[7];
    // const total_bottles = userDataChars[8];
